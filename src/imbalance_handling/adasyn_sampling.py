...
Applies ADASYN for adaptive oversampling.
"""
...
logger = get_logger("ADASYN")


def apply_adasyn(df: pd.DataFrame, target_column: str = "defects") -> pd.DataFrame:
    ...
    logger.info(f"ADASYN applied: {df.shape} -> {df_resampled.shape}")
...
if __name__ == "__main__":
    ...
    logger.info("Running ADASYN standalone...")
    ...
    adasyn_df = apply_adasyn(encoded)

    os.makedirs("data/processed", exist_ok=True)
    save_object("data/processed/adasyn_data.pkl", adasyn_df)
